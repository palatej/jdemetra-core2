...
public class OrdinarySmootherTest {
    ...
    public void testSmoother() {
        ...
        for (int i = 0; i < N; ++i) {
            ...
            Smoother oldsm = new Smoother();
            ec.tstoolkit.ssf.SmoothingResults srslts = new ec.tstoolkit.ssf.SmoothingResults();
            oldsm.setCalcVar(false);
            oldsm.setSsf(new ec.tstoolkit.ssf.ucarima.SsfUcarima(ucm));
            oldsm.process(new ec.tstoolkit.ssf.SsfData(ds, null), srslts);
        }
